...
$fdjmc=$_POST["fdjmc"];
$dw=$_POST["dw"];
$tsfdjdm=$_POST["tsfdjdm"];
$fdjmc1=strtoupper($fdjmc);
$tsfdjdm1=strtoupper($tsfdjdm);
if($addnew=='1'){
ischongfu("select tsfdjdm from teshufadongji where  tsfdjdm='$tsfdjdm1'");
$sql="insert into teshufadongji(tsfdjdm,dw,fdjmc,name) values('$tsfdjdm1','$dw','$fdjmc1','".$_SESSION["username"]."') ";
	mysql_query($sql);
	$sql="insert into czjl(`1` ,`2` ,`3` ,`4` ,`5` ,`6` ,`czfs` ,`name` ) values('$tsfdjdm1','$dw','$fdjmc1','', '', '', '添加','".$_SESSION["username"]."') ";
	mysql_query($sql);
	echo "<script>javascript:alert('添加成功!');location.href='tsfdj.php';</script>";
...
<script language="javascript">
	function check()
{
	if(document.form1.tsfdjdm.value==""||document.form1.fdjmc.value==""||document.form1.dw.value==""){alert("请输入完整！");document.form1.tsfdjdm.focus();return false;}
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
	<tr><td>特殊发动机代码：</td><td><textarea name='tsfdjdm' cols='50' rows='8' id='tsfdjdm' style='border:solid 1px #000000; color:#666666'></textarea>&nbsp;*</td></tr>
	<tr><td>档位：</td><td><textarea name='dw' cols='50' rows='8' id='dw' style='border:solid 1px #000000; color:#666666'></textarea>&nbsp;*</td></tr>
	<tr><td>发动机名称：</td><td><textarea name='fdjmc' cols='50' rows='8' id='fdjmc' style='border:solid 1px #000000; color:#666666'></textarea>&nbsp;*</td></tr>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
	<tr>
    <td width="24" bgcolor="#CCFFFF">特殊发动机代码</td>
    <td width="97" bgcolor='#CCFFFF'>档位</td>
		<td width="99" align="center" bgcolor="#CCFFFF">发动机名称</td>
			<td width="99" align="center" bgcolor="#CCFFFF">添加时间</td>
    <td width="127" align="center" bgcolor="#CCFFFF">操作</td>
	</tr>
	<?php 
    $sql="select * from teshufadongji";
  if ($_POST["bh"]!="")
{
  	$nreqbh=$_POST["bh"];
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ?>
  <tr>
    <td><?php echo mysql_result($query,$i,tsfdjdm);?></td>
    <td><?php echo mysql_result($query,$i,dw);?></td>
	  <td><?php echo mysql_result($query,$i,fdjmc);?></td>
    <td width="99" align="center"><?php echo mysql_result($query,$i,"addtime");?></td>
    <td width="120" align="center"><a href="del.php?id=<?php
		echo mysql_result($query,$i,"id");
	?>&amp;tablename=teshufadongji" onClick="return confirm('真的要删除？')">删除</a>
		<br>
<p>&nbsp;</p>
		</td>
  </tr>
...
<?php
	function ischongfu($sql)
	{
		...
		if($rowscount>0)
		{
			echo "<script>javascript:alert('对不起，该发动机代码重复!');history.back();</script>";
			exit;
		}
